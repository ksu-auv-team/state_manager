...
class path_marker_1(smach.State):
    ...
    def __init__(self):
        ...
        self.pub = rospy.Publisher('path_marker_1_smach_pub', String, queue_size='10')
        rate = rospy.Rate(.5)
    ...
    def execute(self, data):
        ...
        self.sub = rospy.Subscriber("path_marker_1_smach_sub", String, self.callback)
        global recieved
        rospy.loginfo('execute data: %s', recieved)
...
class bouys(smach.State):
    ...
    def __init__(self):
        ...
        self.pub = rospy.Publisher('bouys_smach_pub', String, queue_size='10')
        rate = rospy.Rate(.5)
    ...
    def execute(self, data):
        ...
        self.sub = rospy.Subscriber("bouys_smach_sub", String, self.callback)
        global recieved
        rospy.loginfo('execute data: %s', recieved)
...
class path_marker_2(smach.State):
    ...
    def __init__(self):
        ...
        self.pub = rospy.Publisher('path_marker_2_smach_pub', String, queue_size='10')
        rate = rospy.Rate(.5)
...
class channel(smach.State):
    ...
    def __init__(self):
        ...
        self.pub = rospy.Publisher('channel_smach_pub', String, queue_size='10')
        rate = rospy.Rate(.5)
    ...
    def execute(self, data):
        ...
        self.sub = rospy.Subscriber("channel_smach_sub", String, self.callback)
        global recieved
        rospy.loginfo('execute data: %s', recieved)
...
class hydrophone_1(smach.State):
    ...
    def __init__(self):
        ...
        self.pub = rospy.Publisher('hydrophone_1_smach_pub', String, queue_size='10')
        rate = rospy.Rate(.5)
    ...
    def execute(self, data):
        ...
        self.sub = rospy.Subscriber("hydrophone_1_smach_sub", String, self.callback)
        global recieved
        rospy.loginfo('execute data: %s', recieved)
...
class dropper(smach.State):
    ...
    def __init__(self):
        ...
        self.pub = rospy.Publisher('dropper_smach_pub', String, queue_size='10')
        rate = rospy.Rate(.5)
    ...
    def execute(self, data):
        ...
        self.sub = rospy.Subscriber("dropper_smach_sub", String, self.callback)
        global recieved
        rospy.loginfo('execute data: %s', recieved)
...
class torpedo(smach.State):
    ...
    def __init__(self):
        ...
        self.pub = rospy.Publisher('torpedo_smach_pub', String, queue_size='10')
        rate = rospy.Rate(.5)
    ...
    def execute(self, data):
        ...
        self.sub = rospy.Subscriber("torpedo_smach_sub", String, self.callback)
        global recieved
        rospy.loginfo('execute data: %s', recieved)
...
class hydrophone_2(smach.State):
    ...
    def __init__(self):
        ...
        self.pub = rospy.Publisher('hydrophone_2_smach_pub', String, queue_size='10')
        rate = rospy.Rate(.5)
    ...
    def execute(self, data):
        ...
        self.sub = rospy.Subscriber("hydrophone_2_smach_sub", String, self.callback)
        global recieved
        rospy.loginfo('execute data: %s', recieved)
...
class samples(smach.State):
    ...
    def __init__(self):
        ...
        self.pub = rospy.Publisher('samples_smach_pub', String, queue_size='10')
        rate = rospy.Rate(.5)
    ...
    def execute(self, data):
        ...
        self.sub = rospy.Subscriber("samples_smach_sub", String, self.callback)
        global recieved
        rospy.loginfo('execute data: %s', recieved)
